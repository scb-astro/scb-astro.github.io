...
export const SITE_DATA = {
    ...
    name: 'Dr. Salvador Cardona-Barrero',

    // A brief tagline describing your role or expertise (3-5 words/phrases)
    tagline: "Postdoctoral Researcher | Astrophysics | University of La Laguna",
